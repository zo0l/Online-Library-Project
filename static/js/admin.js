...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (addBookForm && window.location.pathname.includes("add-book")) {
    ...
    if (booksTableBody && window.location.pathname.includes("admin-books")) {
        displayAdminBooks();
    }
        ...
        books.forEach((book, index) => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    ...
                    <a href="/edit-book/?id=${book.id}" style="background-color: #0275d8; color: white; text-decoration: none; padding: 5px 10px; border-radius: 4px; margin-left: 5px; font-size: 14px;">Edit</a>
                </td>
            `;
    ...
    if (editBookForm && window.location.pathname.includes("edit-book")) {
